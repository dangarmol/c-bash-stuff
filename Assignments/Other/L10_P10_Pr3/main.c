	...
	printf("PID=%i\n",pid);
		...
		do {
			...
			else if (strcmp(user_line, "show_params\n")==0)
			{
				 ...
				 * */
				if ((tokens==3) && (val[0] == 0 || val[0] == 1 || val[0] == 2) && (val[1] > 0) && (val[2] > 0)) {
...
int main(int argc, char *argv[])
{
	...
	//Make sure that log messages are displayed right away
	setbuf(logfile,NULL);
	...
	printf("Wait for signal handler to finish...\n");
